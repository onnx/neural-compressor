...
class TestUtilityFunctions(unittest.TestCase):
    ...
    def test_quantize_data(self):
        ...
        scale, zero_point = utility._calculate_scale_zp(np.array([0]), np.array([5]), quantize_range, qType, scheme)
        self.assertEqual(zero_point.dtype, np.int8)

        scale, zero_point = utility._calculate_scale_zp(np.array([0]), np.array([127]), quantize_range, qType, scheme)
        self.assertEqual(zero_point.dtype, np.int8)
        ...
        scale, zero_point = utility._calculate_scale_zp(np.array([0]), np.array([255]), quantize_range, qType, scheme)
        self.assertEqual(zero_point.dtype, np.uint8)
    ...
    def test_check_model_with_infer_shapes(self):
        ...
        self.assertTrue(
            utility.check_model_with_infer_shapes(
